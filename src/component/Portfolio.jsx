...
const Portfolio = () => {
  return (
    <>
      <div id="Portfolio" className="flex justify-center items-center flex-col h-full bg-black">
        <div className="flex justify-center items-center flex-col text-white  mt-[50px] w-full">
          ...
          <div className=" my-5 w-[85%] text-justify text-[13px] md:text-[16px] md:text-center">
            <p className="mt-1">
            My portfolio design embodies simplicity and elegance, focusing on user-centric navigation and engagement. Through clean layouts,and intuitive
            </p>
            <p className="mt-1">
