...
const Skilled = () => {
  return (
    <>
      <div className="flex justify-center white items-center flex-col font-poppin bg-black text-white h-[1100px] md:h-[790px] w-full">
        <div className="flex justify-center items-center flex-col ">
          ...
          <span >
            I am a seasoned web developer with a passion for crafting  immersive
            digital experiences. Proficient in both front-end and back-end. 
          </span>
          <br className="hidden md:block" /> 
          <span>Merging innovation and precision, I build web experiences that captivate audiences.</span>
          </div>
